          ...
          <table aria-label={t("tableLabel")} className="w-full border-collapse text-sm">
            <thead>
              <tr>
                <th
                  scope="col"
                  className="pr-4 pb-2 text-left text-xs font-medium tracking-wide text-muted-foreground uppercase last:pr-0"
                >
                ...
                <th
                  scope="col"
                  className="pr-4 pb-2 text-right text-xs font-medium tracking-wide text-muted-foreground uppercase last:pr-0"
                >
                  {t("columns.dueOn")}
                </th>
                <th
            ...
            <tbody>
              {invoices.map((invoice) => (
                <tr key={invoice.id} className="relative border-t border-border hover:bg-chrome">
