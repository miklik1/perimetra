...
function SecurityContent() {
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-md flex-col gap-4 p-8 text-sm">
        ...
        {enabled ? (
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-1">
              ...
              <code className="bg-muted break-all rounded px-2 py-1 text-xs">{setup.totpURI}</code>
            </div>
            <div className="flex flex-col gap-1">
