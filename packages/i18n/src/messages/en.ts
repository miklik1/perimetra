...
const en: MessagesInput = {
  ...
  // See the cs catalog for the PROVISIONAL (CAR-27 pass 2) flag and why the
  // document-type heading / payment-method label / §92e legend carry no keys.
  invoices: {
    title: "Invoices",
    checkingSession: "Verifying session…",
    empty: "No invoices yet.",
    emptyDescription: "An invoice is issued from an order.",
    ...
    lineage: {
      supersededTitle: "Superseded by a newer document",
      supersededBody: "This invoice was superseded — the newer document applies.",
      viewSuperseding: "View the superseding document",
    },
    payment: {
      title: "Payment",
      body: "An admin confirms payment from the bank statement. Payment state is row state — it is not part of the document content.",
      markPaid: "Mark as paid",
      marking: "Saving…",
      unmarkPaid: "Undo mark as paid",
      unmarking: "Saving…",
      note: "Payment note",
      notePlaceholder: "e.g. VS 20260001, statement 7/2026",
      paidAt: "Paid at",
      paidNote: "Note",
      marked: "Invoice marked as paid.",
      unmarked: "Payment mark removed.",
      adminOnly: "Only an admin can confirm payment.",
      rejected: {
        alreadyPaid: "The invoice is already marked as paid.",
        notPaid: "The invoice is not marked as paid.",
      },
    },
    trust: {
      title: "Verifiable document",
      body: "This document can be re-derived from its frozen inputs at any time — byte for byte (I3).",
    ...
    issue: {
      open: "Issue an invoice",
      title: "Issue an invoice from an order",
      ...
      orderRequired: "An invoice cannot be issued without an order — select one above.",
      noOrders: "No order available to invoice.",
      note: "Note on the document",
      notePlaceholder: "Optional — printed on the document.",
      rejected: {
        legalProfileRequiredTitle: "Company profile missing",
        legalProfileRequiredBody:
          "Complete the company billing details in settings — a document cannot be issued without supplier identification.",
        legalProfileIncompleteTitle: "Company profile has no company ID",
        legalProfileIncompleteBody:
          "Add the company ID to the company profile — the document must state it.",
        ibanRequiredTitle: "IBAN missing",
        ibanRequiredBody:
          "Add the IBAN to the company profile — without it the document cannot state where to pay.",
        customerRequiredTitle: "The order has no customer",
        customerRequiredBody:
          "A document must be addressed. Attach a customer on the underlying quote.",
        customerAnonymizedTitle: "The customer was anonymized",
        customerAnonymizedBody:
          "The customer's data was erased on request — a document naming them can no longer be issued.",
        supplierNotVatPayerTitle: "You are not a VAT payer but the price list charges VAT",
        supplierNotVatPayerBody:
          "A non-payer must not state VAT on a document (§108 ZDPH). Set the price list VAT rate to 0%, or add the VAT registration to the company profile.",
        section29IncompleteTitle: "The document does not meet §29 requirements",
        section29IncompleteBody:
          "A mandatory field is missing — add the supplier VAT ID, and the customer VAT ID under reverse charge.",
        invoiceExistsTitle: "The order already has an invoice",
        invoiceExistsBody:
          "Only one live invoice may exist per order. You will find it in the invoice list.",
        orderCancelledTitle: "The order is cancelled",
        orderCancelledBody: "A document cannot be issued from a cancelled order.",
      },
    },
    print: {
      open: "Open the document (print / PDF)",
      ...
      colVat: "VAT",
      colGross: "Gross",
      vatRecap: "VAT recapitulation",
      subtotalBase: "Total net",
      vatTotal: "Total VAT",
      rounding: "Rounding",
      total: "Total due",
      exchangeRate: "Exchange rate",
      subtotalBaseCzk: "Total net (CZK)",
      vatTotalCzk: "Total VAT (CZK)",
      totalCzk: "Total (CZK)",
      correctsNumber: "Corrects document",
      note: "Note",
      issuedBy: "Issued by {system}",
    },
  },
  quotes: {
    title: "Quotes",
  ...
  admin: {
    ...
    priceTablesActive: "Latest",
    priceTablesDescription:
      "Published price tables are immutable — a newer version supersedes the previous one from its effective date.",
    loadingList: "Loading…",
    ...
    upgradeAvailable: "Newer version available",
