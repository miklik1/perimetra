...
| [0057](0057-org-invite-member-sharing.md)   | Org invite + member sharing: Better-Auth-owned invite lifecycle, custom ac roles (server/client copies), invite email via email module, deterministic active-org, /team UI + switcher + accept page | Accepted | Implemented (auto-provision personal-org wart + sticky-switch deferred)                       |
